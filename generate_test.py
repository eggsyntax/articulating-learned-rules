...
if __name__ == '__main__':
    ...
    parser.add_argument('--description', type=str,
                      default="The classification task is to identify sentences which contain any of the words 'dog', 'less', 'when', 'from', or 'ice'. Sentences should be classified true if and only if they contain one of those five words, and otherwise false.")
